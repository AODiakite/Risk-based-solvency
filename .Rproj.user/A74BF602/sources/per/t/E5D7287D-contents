...
#' taux_BAM : Représente la table de taux obtenu grace à la fonction get_taux_BAM2
...
# interpolation2 des taux actuariels pour avoir des taux de Maturité pleine ----
#' TA : La table de taux actuariel obtenue grace à la fonction get_taux_act2
#' Valeurs retournées : Data frame
#' Contenue du DF retournée : Maturité, Taux actuariel, Taux actuariel en pourcentage
...
#' T_INTER: resultat de la fonction interpolation2
#' Valeurs retournées : Data frame
