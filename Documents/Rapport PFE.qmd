...
<div style="text-align:center">
![Fonctionnement des réseaux de neurones récurrents](Rapport-PFE_files/figure-html/Shema_RNN.png){#fig-RNN}
</div>
...
<div style="text-align:center">
![Le cours Historiques de Clôture pour l’indice MASI](Rapport-PFE_files/figure-html/Derniere.png){#fig-Derniere1}
</div>
...
<div style="text-align:center">
![Courbes de cours prédit et cours réel](Rapport-PFE_files/figure-html/prediction.png){#fig-prediction1}
</div>
...
Selon le circulaire de l'ACAPS, la marge de risque est calculée séparément pour les engagements vie et rentes découlant des opérations non vie ainsi que pour les engagements des opérations non vie comme suit :
$$
...
\underline{\textebf{Hypothèse N°1 :}}
...
On peut constater que les $f_{i,j}$ sont à peu près alignés autout des {f_j} ce qui nous
pousse a validé la prémière hypothèse de Chian Ladder.\\


\underline{\textebf{Hypothèse N°2 :}}
