...
$$
CSR_{Ch_{i}} = max (CSR_{i}(Aug) \quad  ; \quad CSR_{i}(Dim))
$$
...
méthode décrit dans **l’annexe 9** du circulaire de l’ACAPS.Cette méthode et comme suit :  
...
$$
Les valeurs de x1, x2 et x3 malheureusement ne sont pas encore publié par l’ACAPS.
...
$${#eq-gbmp}
avec :
$BE(Choc)$ : Meilleure estimation après le choc par un coefficient X%, ce taux est estimé par l’ACAPS de 0,2 %.
